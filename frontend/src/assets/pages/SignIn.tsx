    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-muted-foreground mb-8">{isSignUp ? "Sign up to start your fitness journey" : "Sign in to continue your fitness journey"}</p>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-2 text-muted-foreground">Or {isSignUp ? "sign up" : "continue"} with</span>
            </div>
          </div>
            ...
            {!isSignUp && (
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded border-muted-foreground/20 text-primary focus:ring-primary" />
          ...
          <p className="mt-4 text-center text-sm">
            ...
            <button className="text-primary hover:underline" onClick={toggleForm}>
        ...
        <div className="max-w-md">
            ...
            <CardContent className="p-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm opacity-75">Marathon Runner</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/10 backdrop-blur-sm text-white">
            <CardContent className="p-6">
              ...
              <p className="text-4xl font-bold mb-2">+78,12%</p>
